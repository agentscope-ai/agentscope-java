...
public enum ModelProviderType {
    DASHSCOPE("dashscope") {
        ...
        public Model createModel(AgentscopeProperties properties) {
            AgentscopeProperties.DashscopeProperties dashscope = properties.getDashscope();
    ...
    OPENAI("openai") {
        @Override
        public Model createModel(AgentscopeProperties properties) {
            AgentscopeProperties.OpenAIProperties openai = properties.getOpenai();
            if (!openai.isEnabled()) {
                throw new IllegalStateException(
    ...
    GEMINI("gemini") {
        @Override
        public Model createModel(AgentscopeProperties properties) {
            AgentscopeProperties.GeminiProperties gemini = properties.getGemini();
            if (!gemini.isEnabled()) {
                throw new IllegalStateException(
    ...
    ANTHROPIC("anthropic") {
        @Override
        public Model createModel(AgentscopeProperties properties) {
            AgentscopeProperties.AnthropicProperties anthropic = properties.getAnthropic();
    ...
    public static ModelProviderType fromProperties(AgentscopeProperties properties) {
        AgentscopeProperties.ModelProperties modelProps = properties.getModel();
