 ...
 *
 * <p>This example shows three ways to use BailianKnowledge:
 * <ol>
 *   <li>Direct retrieval from knowledge base
 *   <li>Using KnowledgeRetrievalTools for agent-based retrieval
 *   <li>Integration with ReActAgent for autonomous RAG
 * </ol>
 *
 * <p>Prerequisites:
 * <ul>
 *   <li>Set ALIBABA_CLOUD_ACCESS_KEY_ID environment variable
 *   <li>Set ALIBABA_CLOUD_ACCESS_KEY_SECRET environment variable
 *   <li>Set BAILIAN_WORKSPACE_ID environment variable
 *   <li>Set BAILIAN_INDEX_ID environment variable
 *   <li>Set DASHSCOPE_API_KEY environment variable (for agent example)
 * </ul>
 */
