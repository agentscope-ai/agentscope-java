 ...
 *
 * <ul>
 *   <li>Fanout execution: distributing the same input to multiple agents
 *   <li>Concurrent vs Sequential execution mode comparison
 *   <li>Collecting and aggregating results from multiple agents
 *   <li>Performance comparison between parallel and sequential execution
 * </ul>
 *
 * <p>Workflow:
 *
 * <pre>
 * Product Idea Input
 *        ↓ (distributed to 3 experts simultaneously)
 *        ├─→ Technical Expert (assess feasibility)
 *        ├─→ UX Expert (evaluate user experience)
 *        └─→ Business Analyst (analyze market value)
 *        ↓
 ...
 * <pre>
 * cd examples
 * mvn exec:java -Dexec.mainClass="io.agentscope.examples.FanoutPipelineExample"
 * </pre>
 *
 * <p>Requirements:
 *
