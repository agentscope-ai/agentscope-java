 ...
 *
 * <ul>
 *   <li>Creating multiple agents with different roles
 *   <li>Using MsgHub for automatic message broadcasting
 *   <li>Basic multi-agent conversation with block() style
 *   <li>Reactive multi-agent conversation with Mono.then() pattern
 * </ul>
 *
 * <p><b>Key Concept:</b> MsgHub simplifies multi-agent conversations by automatically broadcasting
 * each agent's response to all other participants. This eliminates the need for manual message
 * passing between agents.
 *
 * <p>Run:
 *
 * <pre>
 * mvn exec:java -Dexec.mainClass="io.agentscope.examples.MsgHubExample"
 * </pre>
 *
 * <p>Requirements:
 *
