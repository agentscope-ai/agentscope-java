 ...
 *
 * <ul>
 *   <li>Creating tool groups to organize tools
 *   <li>Agent autonomously enabling tool groups using reset_equipped_tools meta-tool
 *   <li>Agent deciding which tools to activate based on task requirements
 * </ul>
 *
 * <p>Run:
 *
 ...
 * </pre>
 *
 * <p>The agent can autonomously activate tool groups using the reset_equipped_tools meta-tool.
 */
