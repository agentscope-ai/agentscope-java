 ...
 *
 * <ul>
 *   <li>Sequential execution of multiple agents in a pipeline
 *   <li>Output chaining: each agent's output becomes the next agent's input
 *   <li>Real-world content processing scenario
 *   <li>Building pipelines using the Builder pattern
 * </ul>
 *
 * <p>Workflow:
 *
 ...
 *        ↓
 * Agent 1: Translator (English → Chinese)
 *        ↓
 * Agent 2: Summarizer (Generate summary)
 *        ↓
 * Agent 3: Sentiment Analyzer (Analyze sentiment)
 *        ↓
 * Final Result (Sentiment analysis with summary)
 * </pre>
 *
 * <p>Run:
 *
 * <pre>
 * cd examples
 * mvn exec:java -Dexec.mainClass="io.agentscope.examples.SequentialPipelineExample"
 * </pre>
 *
 * <p>Requirements:
 *
