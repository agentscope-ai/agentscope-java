...
class GLMApiDebugTest {
    ...
    private static final String BASE_URL = System.getenv().getOrDefault("GLM_BASE_URL",
            "https://open.bigmodel.cn/api/paas/v4/");
    private static final String MODEL = System.getenv().getOrDefault("GLM_MODEL_NAME", "glm-4-plus");
                    ...
                    .forEach(
                            block -> {
                                ...
                                if (block instanceof io.agentscope.core.message.TextBlock) {
                                    System.out.println(
                                            "  Text: "
                                                    + ((io.agentscope.core.message.TextBlock) block)
                                                            .getText());
                                } else if (block
