...
/**
 * Multi-agent formatter for OpenAI o1 reasoning models (o1, o1-mini, o1-preview).
 *
 * <p>This formatter extends {@link OpenAIMultiAgentFormatter} with o1-specific options handling:
 * <ul>
 ...
 *   <li>Only applies max_completion_tokens, seed, and reasoning_effort</li>
 ...
 *     .formatter(new OpenAIO1MultiAgentFormatter())
 *     .modelName("o1-mini")
 *     .apiKey(apiKey)
 *     .build();
 * }</pre>
 */
public class OpenAIO1MultiAgentFormatter extends OpenAIMultiAgentFormatter {

    private static final Logger log = LoggerFactory.getLogger(OpenAIO1MultiAgentFormatter.class);

    /**
     * Create an OpenAIO1MultiAgentFormatter with default conversation history prompt.
     */
    public OpenAIO1MultiAgentFormatter() {
        super();
    }

    /**
     * Create an OpenAIO1MultiAgentFormatter with custom conversation history prompt.
     *
     * @param conversationHistoryPrompt The prompt to prepend before conversation history
     */
    public OpenAIO1MultiAgentFormatter(String conversationHistoryPrompt) {
    ...
    // Inherits multi-agent formatting, tools, and tool_choice handling from
