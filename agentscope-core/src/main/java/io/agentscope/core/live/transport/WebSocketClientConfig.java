 ...
 *     .build();
 *
 * WebSocketClient client = OkHttpWebSocketClient.create(config);
 * }</pre>
 */
public class WebSocketClientConfig {
    ...
    /**
     * Create a new builder for WebSocketClientConfig.
     *
     ...
     *
     * @return a default WebSocketClientConfig instance
     */
    ...
    /**
     * Builder for WebSocketClientConfig.
     */
    public static class Builder {
        ...
        /**
         * Build the WebSocketClientConfig.
         *
