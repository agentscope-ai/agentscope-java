...
public class OpenAIMultiModalTool {
     ...
     *                       <li>URLs are only valid for 60 minutes after the image has been generated.</li>
     *                       </ul>
     * @return The created image variation(s).
     */
    @Tool(
     ...
     * @return The descriptive text generated by the model.
     */
     ...
     * @return A ToolResponse containing the generated base64 data of the audio file or error message if the operation failed..
     */
    @Tool(
     ...
     * @return A ToolResultBlock containing the transcribed text or an error message.
     */
    @Tool(
