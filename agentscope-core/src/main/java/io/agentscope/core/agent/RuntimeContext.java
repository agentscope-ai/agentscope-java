...
public class RuntimeContext {
    ...
    /**
     * Stable per-call correlation id. Always non-null: auto-generated by the {@link Builder} when
     * not explicitly supplied. Use this to correlate logs, events, and traces for a single
     * {@code call()} invocation, and as the key for active-context registries.
     */
    ...
    /**
     * Returns the stable per-call correlation id. Always non-null: auto-generated by the builder
    ...
    public static class Builder {
        ...
        /**
         * Sets an explicit run id. When not supplied (or blank), {@link #build()} auto-generates a
         * unique id so that {@link RuntimeContext#getRunId()} is always non-null.
         *
         * @param runId the run id, or {@code null} to auto-generate
         * @return this builder
         */
