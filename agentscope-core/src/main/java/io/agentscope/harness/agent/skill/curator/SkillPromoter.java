...
public class SkillPromoter {
        ...
        if (!SkillSecurityScanner.shouldAllow(
            ...
            return Mono.just(
                    PromotionResult.rejected(
                            "security scan blocked promotion (" + scan.verdict() + ")",
                            scan));
        }
    ...
    private SkillCandidate buildCandidate(AgentSkill skill, SkillSecurityScanner.ScanResult scan) {
        ...
        SkillUsageRecord usage = usageStore != null ? usageStore.get(skill.getName()).orElse(null) : null;
    ...
    public record PromotionResult(
        ...
        public static PromotionResult approved(
            ...
            return new PromotionResult(
                    Status.APPROVED, "approved", environments, reviewerId, scan);
        }
        ...
        public static PromotionResult rejected(String reason, SkillSecurityScanner.ScanResult scan) {
