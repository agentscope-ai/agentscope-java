...
public class EscalatingShellExecuteTool {
    ...
    @Tool(
            description =
                    "Execute a shell command. Use for git, npm, build, test, and other terminal"
                        ...
                        + " sandbox_permissions (one of: workspace-write, danger-full-access)"
                        + " together with a justification sentence; the user approves or denies the"
    ...
    public String execute(
            ...
            @ToolParam(
                            ...
                            description =
                                    "Optional: request a strictly wider permission mode for"
                                            + " this single call. One of: workspace-write,"
                                            + " danger-full-access (read-only is the floor and"
                                            + " never strictly wider, so it is not requestable)."
                                            + " Must be paired with a justification.",
                            required = false)
