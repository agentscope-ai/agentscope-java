...
final class WorkspacePromptTestSupport {
    static String render(
            WorkspaceContextMiddleware middleware, RuntimeContext context, String base) {
        RuntimeContext rc = context == null ? RuntimeContext.empty() : context;
        String prompt = middleware.onSystemPrompt(null, rc, base).block();
        assertEquals(base == null ? "" : base, prompt);
        return prompt
                + "\n"
