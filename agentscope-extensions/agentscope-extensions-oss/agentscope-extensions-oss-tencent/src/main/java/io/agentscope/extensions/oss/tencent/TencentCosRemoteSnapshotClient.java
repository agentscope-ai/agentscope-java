...
public class TencentCosRemoteSnapshotClient extends AbstractOssRemoteSnapshotClient {
     ...
     */
    public TencentCosRemoteSnapshotClient(
            COSClient cosClient, String bucketName, String keyPrefix) {
        super(new TencentCosOssAdapter(cosClient, bucketName), bucketName, keyPrefix);
    }
}
