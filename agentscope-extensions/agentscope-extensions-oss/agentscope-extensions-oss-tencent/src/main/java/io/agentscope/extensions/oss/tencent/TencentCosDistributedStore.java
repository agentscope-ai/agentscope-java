 ...
 *     .distributedStore(TencentCosDistributedStore.create(cosClient, "my-bucket", "agentscope/"))
 *     .build();
 * }</pre>
 */
public class TencentCosDistributedStore implements DistributedStore {

    private final COSClient cosClient;
    private final String bucketName;
    private final String keyPrefix;

    private TencentCosDistributedStore(COSClient cosClient, String bucketName, String keyPrefix) {
     ...
     */
    public static TencentCosDistributedStore create(
            COSClient cosClient, String bucketName, String keyPrefix) {
        return new TencentCosDistributedStore(cosClient, bucketName, keyPrefix);
    }

    @Override
    public AgentStateStore agentStateStore() {
        return TencentCosAgentStateStore.builder()
                .cosClient(cosClient)
    ...
    public BaseStore baseStore() {
        return TencentCosBaseStore.builder()
                .cosClient(cosClient)
                .bucketName(bucketName)
    ...
    public SandboxSnapshotSpec sandboxSnapshotSpec() {
        return new TencentCosSnapshotSpec(cosClient, bucketName, keyPrefix + "snapshot/");
    }
}
