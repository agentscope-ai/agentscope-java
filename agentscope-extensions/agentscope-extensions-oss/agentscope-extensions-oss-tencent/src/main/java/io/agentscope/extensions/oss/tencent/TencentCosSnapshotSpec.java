...
public class TencentCosSnapshotSpec extends RemoteSnapshotSpec {
     ...
     */
    public TencentCosSnapshotSpec(COSClient cosClient, String bucketName, String keyPrefix) {
        super(new TencentCosRemoteSnapshotClient(cosClient, bucketName, keyPrefix));
    }
}
