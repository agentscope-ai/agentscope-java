...
/**
 * Tencent Cloud COS backed {@link BaseStore}.
 *
 * <p>Usage:
 *
 * <pre>{@code
 ...
 *
 * BaseStore store = TencentCosBaseStore.builder()
 *     .cosClient(cosClient)
 ...
 * }</pre>
 */
public class TencentCosBaseStore extends AbstractOssBaseStore {

    private TencentCosBaseStore(Builder builder) {
        super(
    ...
    public static class Builder {
        ...
        public TencentCosBaseStore build() {
            return new TencentCosBaseStore(this);
        }
    }
}
