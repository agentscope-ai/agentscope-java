...
public class AliyunOssSnapshotSpec extends RemoteSnapshotSpec {
     ...
     */
    public AliyunOssSnapshotSpec(OSS ossClient, String bucketName, String keyPrefix) {
        super(new AliyunOssRemoteSnapshotClient(ossClient, bucketName, keyPrefix));
    }

    /**
     * Creates an OSS snapshot spec from endpoint/credential settings.
     *
     * @param endpoint OSS endpoint (e.g. {@code oss-cn-hangzhou.aliyuncs.com})
     * @param accessKeyId access key id
     * @param accessKeySecret access key secret
     * @param bucketName target bucket
     * @param keyPrefix key prefix (optional, may be null/blank)
     */
    public AliyunOssSnapshotSpec(
            String endpoint,
            String accessKeyId,
