...
public final class DingTalkChannel implements Channel {
     ...
     * fresh one.
     */
    private final Function<DingTalkChannelProperties, AccessTokenStore> tokenStoreFactory;
    ...
    private DingTalkChannel(
            ...
            Function<DingTalkChannelProperties, AccessTokenStore> tokenStoreFactory) {
