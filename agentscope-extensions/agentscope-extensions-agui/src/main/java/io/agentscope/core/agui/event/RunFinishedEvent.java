 ...
 *
 * <p>This is the last event emitted when an agent completes processing a request.
 */
public final class RunFinishedEvent implements AguiEvent {
    ...
    public String toString() {
        return "RunFinishedEvent{threadId='" + threadId + "', runId='" + runId + "'}";
    }
}
