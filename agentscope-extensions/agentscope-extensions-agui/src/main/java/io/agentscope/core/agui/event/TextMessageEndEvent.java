 ...
 *
 * <p>This event is emitted when the agent has finished generating a text message
 * that was started with {@link TextMessageStartEvent}.
 */
public final class TextMessageEndEvent implements AguiEvent {
    ...
    public String toString() {
        return "TextMessageEndEvent{threadId='"
                + threadId
                + "', runId='"
                + runId
                + "', messageId='"
