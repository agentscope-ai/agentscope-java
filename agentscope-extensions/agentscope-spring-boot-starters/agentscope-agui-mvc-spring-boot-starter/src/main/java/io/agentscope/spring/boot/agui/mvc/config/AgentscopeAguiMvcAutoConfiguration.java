...
@EnableConfigurationProperties(AguiMvcProperties.class)
public class AgentscopeAguiMvcAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public ThreadSessionManager threadSessionManager(AguiMvcProperties props) {
    ...
    public AguiRestController aguiRestController(
            AguiMvcController aguiMvcController, AguiMvcProperties props) {
