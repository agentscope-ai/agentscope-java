...
public final class BuiltinCommandRegistrar {
    ...
    public void registerBuiltins() {
        ...
        registry.register(new AdminCommand(
                "session.list",
                "List sessions",
                "Session",
                CommandPlane.DATA,
        ...
        registry.register(new AdminCommand(
                ...
                true,
                false,
                "Restore the AgentState snapshot taken before the most recent compact/undo"));
        registry.register(new AdminCommand(
                "session.redo",
        ...
        registry.register(new AdminCommand(
                ...
                false,
                true,
                "Return whether plan mode is active, the current plan file, and middleware presence"));
        registry.register(new AdminCommand(
        ...
        registry.register(new AdminCommand(
                ...
                false,
                true,
                "Read AgentState.tasksContext: subject/state/owner/blocks/blockedBy for each task"));
        ...
        registry.register(new AdminCommand(
                ...
                false,
                true,
                "List BackgroundTasks dispatched to subagents (optional ?status=RUNNING|COMPLETED|...)"));
        registry.register(new AdminCommand(
                "subagent.task.get",
        ...
        registry.register(new AdminCommand(
                ...
                true,
                true,
                "Request cancellation of a subagent BackgroundTask via TaskRepository.cancelTask"));
        ...
        registry.register(new AdminCommand(
                ...
                false,
                true,
                "Enumerate subagents declared in the process (via Spring SubagentEntry/Declaration beans)"));
    }
}
