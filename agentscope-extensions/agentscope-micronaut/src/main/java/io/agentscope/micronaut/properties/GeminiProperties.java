 ...
 * }</pre>
 */
@ConfigurationProperties("agentscope.gemini")
public class GeminiProperties {
    ...
    /**
     * Gemini API key (required for direct API access).
     */
    ...
    /**
     * GCP location (required for Vertex AI), for example {@code us-central1}.
     */
