...
6. **向量存储选择**：
   ...
   - 使用 **ElasticstoreStore**: 生产环境、大型数据集、私有部署服务。
...
- **Elasticsearch 知识库实例**: [RAGExample.java](https://github.com/agentscope-ai/agentscope-java/blob/main/agentscope-examples/advanced/src/main/java/io/agentscope/examples/advanced/ElasticsearchRAGExample.java)