...
If you are still evaluating whether to migrate, the [Changelog](/v2/change-log) breaks down every change with a Migration Guide (must-do vs. recommended) and a What's New section — enough to plan an upgrade end-to-end.
