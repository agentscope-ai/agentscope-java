...
- **Workflow mode**: [Pipeline](pipeline.md), [Routing](routing.md), [Custom Workflow](workflow.md). The flow moves between agents or nodes; each node may interact with the user.
