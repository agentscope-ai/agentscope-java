...
/**
 * Live {@code sessionId -> Sandbox} handles registered by an Environment Worker (see {@link
 * InProcessEnvironmentWorker} or a real remote worker calling the worker REST API).
 *
