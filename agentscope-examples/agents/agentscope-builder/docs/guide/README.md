# AgentScope Builder · Managed Agents 产品指南
...
| [MANAGED_AGENTS_API.md](../MANAGED_AGENTS_API.md) | HTTP 路由对照与缺口表 |
| [events/](../events/README.md) | 事件类型与错误契约 |
| [DATA_PLANE_CONTRACT.md](../DATA_PLANE_CONTRACT.md) | 数据面设计说明 |
| [FOLLOW_UP_PRODUCTION.md](../FOLLOW_UP_PRODUCTION.md) | 生产债与多副本限制 |
| [SELF_HOSTED_GAPS.md](../SELF_HOSTED_GAPS.md) | self_hosted Hands 待完善清单 |
| [SANDBOX_GAPS.md](../SANDBOX_GAPS.md) | Managed sandbox（E2B）待完善清单 |
