...
下面只列 **用户集成时容易撞到** 的限制。完整缺口表见 [MANAGED_AGENTS_API.md §4](../MANAGED_AGENTS_API.md)；生产债见 [FOLLOW_UP_PRODUCTION.md](../FOLLOW_UP_PRODUCTION.md)。
...
| **E2B packages / networking** | `type=sandbox` 用 template 承载运行时；Claude 式 packages/limited 网络未强制，见 [SANDBOX_GAPS.md](../SANDBOX_GAPS.md) |
...
3. [SELF_HOSTED_GAPS.md](../SELF_HOSTED_GAPS.md) / [SANDBOX_GAPS.md](../SANDBOX_GAPS.md)  
4. [FOLLOW_UP_PRODUCTION.md](../FOLLOW_UP_PRODUCTION.md) 多副本债  
5. [MANAGED_AGENTS_API.md](../MANAGED_AGENTS_API.md) 路由对照
