 ...
 * </ul>
 *
 * <p>The signing secret is read from the {@code claw.jwt.secret} application property (defaults to
 * a development-only placeholder — <strong>must be overridden in production</strong>).
 */
@Service
public class JwtService {
    ...
    public JwtService(
            @Value("${claw.jwt.secret:claw-default-dev-secret-change-in-production-32chars}")
                    String secret) {
