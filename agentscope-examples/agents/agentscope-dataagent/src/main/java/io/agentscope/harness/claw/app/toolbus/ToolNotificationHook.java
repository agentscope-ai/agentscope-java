 ...
 * {@link ToolEventBus} after reasoning, enabling real-time SSE streaming of tool calls in
 * {@link io.agentscope.harness.claw.app.api.ChatController}.
 *
 * <p>The session key is derived from {@link RuntimeContext#getSessionKey()}.
 */
