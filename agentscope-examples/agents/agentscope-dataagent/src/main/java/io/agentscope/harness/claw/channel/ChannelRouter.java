 ...
 * "agentId"} so that {@link io.agentscope.harness.claw.gateway.HarnessGateway#run} can pick the correct
...
public final class ChannelRouter {
     ...
     *     io.agentscope.harness.claw.gateway.Gateway#bindMainAgent}
     */
     ...
     * io.agentscope.harness.claw.gateway.Gateway#run}.
     *
