 ...
 */
package io.agentscope.harness.claw.channel;
 ...
 * delegates execution to {@link io.agentscope.harness.claw.gateway.Gateway}.
 *
 * <p>Each implementation handles one channel protocol:
 *
 * <ul>
 *   <li>{@link io.agentscope.harness.claw.channel.chatui.ChatUiChannel} — direct programmatic / Chat UI
 ...
 *
 * Implementations call {@link io.agentscope.harness.claw.gateway.Gateway#run} with the {@link
 * io.agentscope.harness.claw.gateway.MsgContext} produced by {@link ChannelRouter#resolveRoute}. The
 * returned {@link Msg} reply is delivered back to the originating platform by the channel adapter.
 *
 * @see ChannelConfig
 * @see ChannelRouter
 * @see io.agentscope.harness.claw.gateway.Gateway
 */
