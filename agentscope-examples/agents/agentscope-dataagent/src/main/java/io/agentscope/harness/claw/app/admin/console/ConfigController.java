 ...
 * {@code agentscope.json} directly and restart the application.
 *
...
public class ConfigController {
    ...
    public ConfigController(@Value("${claw.workspace:}") String workspaceDir) {
        Path cwd =
    ...
    /** Returns the raw {@code agentscope.json} as a JSON tree. */
