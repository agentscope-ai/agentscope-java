 ...
 *
 * <p>The {@code peerId} is used by {@link io.agentscope.harness.claw.channel.ChannelRouter} to build a
 * stable session key:
 *
 * <ul>
 *   <li>If {@code peerId} is null (or blank) and the channel's {@link
 *       io.agentscope.harness.claw.channel.DmScope} is {@link
 *       io.agentscope.harness.claw.channel.DmScope#MAIN}, all requests without a peer share the same
 ...
 *       io.agentscope.harness.claw.channel.DmScope#PER_PEER} or similar scopes).
 * </ul>
 *
