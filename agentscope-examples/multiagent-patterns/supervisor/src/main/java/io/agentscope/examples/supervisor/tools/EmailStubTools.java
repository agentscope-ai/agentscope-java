...
public class EmailStubTools {
	...
	public String sendEmail(
			@ToolParam(name = "to", description = "List of recipient email addresses") List<String> to,
			@ToolParam(name = "subject", description = "Email subject") String subject,
			@ToolParam(name = "body", description = "Email body") String body,
			@ToolParam(name = "cc", description = "CC recipients", required = false) List<String> cc) {
