...
public class CalendarStubTools {
	...
	public String createCalendarEvent(
			...
			@ToolParam(name = "startTime", description = "Start time in ISO format, e.g. 2024-01-15T14:00:00") String startTime,
			@ToolParam(name = "endTime", description = "End time in ISO format, e.g. 2024-01-15T15:00:00") String endTime,
			@ToolParam(name = "attendees", description = "List of attendee email addresses") List<String> attendees,
			@ToolParam(name = "location", description = "Event location", required = false) String location) {
	...
	public String getAvailableTimeSlots(
			@ToolParam(name = "attendees", description = "List of attendee email addresses") List<String> attendees,
			@ToolParam(name = "date", description = "Date in ISO format, e.g. 2024-01-15") String date,
			@ToolParam(name = "durationMinutes", description = "Duration in minutes") int durationMinutes) {
