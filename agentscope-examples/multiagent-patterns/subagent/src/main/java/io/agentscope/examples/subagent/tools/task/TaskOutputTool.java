...
public class TaskOutputTool {
	...
	public String taskOutput(
			@ToolParam(name = "task_id", description = "The task ID returned by the Task tool when run_in_background was true", required = true) String taskId,
			@ToolParam(name = "block", description = "Whether to wait for completion (default: true)", required = false) Boolean block,
			@ToolParam(name = "timeout", description = "Max wait time in milliseconds (default: 30000, max: 600000)", required = false) Long timeout) {
