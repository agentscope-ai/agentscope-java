...
public class RoutingConfig {
	...
	@Bean
	public AgentScopeRoutingAgent routerAgent(Model dashScopeChatModel,
	...
	@Bean
	public RouterService routerService(Model dashScopeChatModel, AgentScopeRoutingAgent routerAgent) {
