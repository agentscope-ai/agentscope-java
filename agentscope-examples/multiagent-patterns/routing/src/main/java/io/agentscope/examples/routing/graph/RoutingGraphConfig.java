...
public class RoutingGraphConfig {
	...
	@Bean
	public AgentScopeRoutingAgent routerAgent(AgentScopeAgent githubAgent,
	...
	@Bean
	public CompiledGraph routingGraph(AgentScopeRoutingAgent routerAgent) throws GraphStateException {
