...
public class RouterService {
	...
	public String synthesize(String query, List<AgentOutput> results) {
		...
		List<Msg> messages = List.of(
				Msg.builder().role(MsgRole.SYSTEM).content(TextBlock.builder().text(systemPrompt).build()).build(),
				Msg.builder().role(MsgRole.USER).content(TextBlock.builder().text(formatted).build()).build());
