...
public class RagAgentConfig {
	...
	@Bean
	public EmbeddingModel ragEmbeddingModel(@Value("${spring.ai.dashscope.api-key:}") String apiKey) {
		String key = StringUtils.hasText(apiKey) ? apiKey : System.getenv("AI_DASHSCOPE_API_KEY");
	...
	private static List<Document> buildSampleDocuments() {
		return List.of(
				doc("New York Liberty 2024 roster: Breanna Stewart, Sabrina Ionescu, Jonquel Jones, Courtney Vandersloot.", "rosters", 0),
				doc("Las Vegas Aces 2024 roster: A'ja Wilson, Kelsey Plum, Jackie Young, Chelsea Gray.", "rosters", 1),
				doc("Indiana Fever 2024 roster: Caitlin Clark, Aliyah Boston, Kelsey Mitchell, NaLyssa Smith.", "rosters", 2),
				doc("2024 WNBA Finals: New York Liberty defeated Minnesota Lynx 3-2 to win the championship.", "games", 3),
				doc("June 15, 2024: Indiana Fever 85, Chicago Sky 79. Caitlin Clark had 23 points and 8 assists.", "games", 4),
				doc("August 20, 2024: Las Vegas Aces 92, Phoenix Mercury 84. A'ja Wilson scored 35 points.", "games", 5),
				doc("A'ja Wilson 2024 season stats: 26.9 PPG, 11.9 RPG, 2.6 BPG. Won MVP award.", "stats", 6),
				doc("Caitlin Clark 2024 rookie stats: 19.2 PPG, 8.4 APG, 5.7 RPG. Won Rookie of the Year.", "stats", 7),
	...
	public CompiledGraph ragGraph(Model ragDashScopeChatModel, Knowledge ragKnowledge)
		...
		AgentScopeAgent ragAgent = AgentScopeAgent.fromBuilder(
				ReActAgent.builder()
						.name("rag_agent")
						.sysPrompt("You are a WNBA stats assistant. Answer questions using the context provided.")
