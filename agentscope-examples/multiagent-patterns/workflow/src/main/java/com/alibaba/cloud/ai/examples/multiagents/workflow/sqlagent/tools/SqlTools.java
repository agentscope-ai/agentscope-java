...
public final class SqlTools {
	...
	public String listTables(@ToolParam(name = "ignored", description = "Empty string", required = false) String ignored) {
	...
	public String getSchema(@ToolParam(name = "tableNames", description = "Comma-separated table names") String tableNames) {
	...
	public String runQuery(@ToolParam(name = "query", description = "SQL query to execute") String query) {
