...
public class MessageSourceGameMessages implements GameMessages {
    ...
    @Override
    public String getPromptWerewolfVote() {
        return msg("prompt.werewolf.vote");
    }

    @Override
    public String getPromptWitchHeal(String victimName) {
        return msg("prompt.witch.heal", victimName);
    }

    @Override
    public String getPromptWitchPoison() {
        return msg("prompt.witch.poison");
    }

    @Override
    public String getPromptSeerCheck() {
        return msg("prompt.seer.check");
    }

    @Override
    public String getPromptDayDiscussion() {
        return msg("prompt.day.discussion");
    }

    @Override
    public String getPromptDayVote() {
        return msg("prompt.day.vote");
    }
