from probe import *
state={'agents':{},'teams':{},'issues':{},'chats':{},'endpoints':{},'invocations':{}}
...
for name,lead,members in [('managed','lead',[('calc','calculator'),('analyst','analyst')]),('mixed','lead',[('qoder','researcher'),('analyst','analyst')])]:
