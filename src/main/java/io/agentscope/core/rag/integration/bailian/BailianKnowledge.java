 ...
 *
 * <p>Unlike {@link io.agentscope.core.rag.knowledge.SimpleKnowledge}, this implementation
 * does not require local embedding models or vector stores. All document storage, embedding,
 * and retrieval are handled by the Bailian cloud service.
 *
 * <p>Key features:
 * <ul>
