...
public class UriPart implements MessagePart {
  ...
  @JsonPropertyDescription("A URI referencing attached data. It should not be a base64 data URL, which should use the `blob` part instead. The URI may use a scheme known to the provider api (e.g. `gs://bucket/object.png`), or be a publicly accessible location")
