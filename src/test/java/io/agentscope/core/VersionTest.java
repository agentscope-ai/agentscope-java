...
class VersionTest {
    ...
    void testVersionConstant() {
        ...
        Assertions.assertEquals("0.2.1-SNAPSHOT", Version.VERSION, "VERSION should match current version");
    }
    ...
    void testGetUserAgent_ExampleFormat() {
        ...
        // Example: agentscope-java/0.2.1-SNAPSHOT; java/17.0.1; platform/Mac OS X
