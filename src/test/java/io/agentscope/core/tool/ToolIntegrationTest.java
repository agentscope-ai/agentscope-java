...
class ToolIntegrationTest {
            ...
            CompletableFuture<ToolResultBlock> future =
                    CompletableFuture.supplyAsync(
                            () -> {
                                ...
                                return addTool.callAsync(ToolCallParam.builder().input(params).build()).block();
                            });
    ...
    void testToolErrorPropagation() {
        ...
        if (errorTool != null) {
            ...
            try {
                ToolResultBlock response = errorTool.callAsync(ToolCallParam.builder().input(params).build()).block();
    ...
    void testToolTimeout() {
        ...
        if (slowTool != null) {
            ...
            ToolResultBlock response = slowTool.callAsync(ToolCallParam.builder().input(params).build()).block();
            ...
            CompletableFuture<ToolResultBlock> future =
                    CompletableFuture.supplyAsync(
                            () -> {
                                ...
                                return slowTool.callAsync(ToolCallParam.builder().input(longParams).build()).block();
                            });
